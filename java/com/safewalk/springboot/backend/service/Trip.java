...
/**
 * Minimal Trip entity. If your project already has a Trip with many fields,
 * merge these getters/setters instead of overwriting.
 */
@Entity
@Table(name = "trips")
public class Trip {
    ...
    @Transient
    private com.safewalk.springboot.backend.entity.CoreLocationUpdate latestLocation;
    ...
    public com.safewalk.springboot.backend.entity.CoreLocationUpdate getLatestLocation() { return latestLocation; }
    public void setLatestLocation(com.safewalk.springboot.backend.entity.CoreLocationUpdate latestLocation) { this.latestLocation = latestLocation; }
}
